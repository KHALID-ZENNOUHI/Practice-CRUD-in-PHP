...
if (isset($_POST['addsubcategory'])) {
    ...
    $insertquery = "INSERT INTO subcategory(subcategoryNom,CategoryID)
                    VALUES ('$name','$categoryid')";
    $mysqliquery = mysqli_query($conn, $insertquery);
}
if (isset($_GET['idsubcategory'])){
    $subcategoryID = $_GET['idsubcategory'];
    $delet = "DELETE FROM `subcategory` WHERE 	SubcategoryID  = $subcategoryID";
    $mysqliquery = mysqli_query($conn, $delet);
}  
if (isset($_POST['editsubcategory'])) {
    $name = mysqli_real_escape_string($conn,$_POST['subcategoryName']);
    $subcategoryid = mysqli_real_escape_string($conn,$_POST['idsubcategory']);
    $categoryid = mysqli_real_escape_string($conn,$_POST['CategoryID']);
    $editquery = "UPDATE `subcategory` SET subcategoryNom = '$name', CategoryID = '$categoryid' where SubcategoryID  = $subcategoryid ";
