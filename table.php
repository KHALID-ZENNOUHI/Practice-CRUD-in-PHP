...
if (isset($_POST['updateuser'])) {
    ...
    $squadID = mysqli_real_escape_string($conn,$_POST['SquadID']);
    $editquery = "UPDATE users SET UserName='$name', UserEmail='$email', Role='$role', SquadID=$squadID where UserID=$UserID ";
	$mysqliquery = mysqli_query($conn, $editquery);
    }
	if (isset($_GET['iduser'])){
		$UserID = $_GET['iduser'];
		$delet = "DELETE FROM `users` WHERE UserID = $UserID";
	...
	if (isset($_POST['adduser'])) {
		...
		$insertquery = "INSERT INTO users(UserName, UserEmail, Role, SquadID)
						VALUES ('$name','$email','$role','$squadID')";
